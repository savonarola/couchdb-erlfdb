...
%% Semi-automatically generated from the fdb_c_options.g.h

-ifndef(FDB_C_OPTIONS_G_H).
-define(FDB_C_OPTIONS_G_H, true).

%% Deprecated
%% Parameter: (String) IP:PORT
-define(FDB_NET_OPTION_LOCAL_ADDRESS, 10).

%% Deprecated
%% Parameter: (String) path to cluster file
-define(FDB_NET_OPTION_CLUSTER_FILE, 20).

%% Enables trace output to a file in a directory of the clients choosing
%% Parameter: (String) path to output directory (or NULL for current working directory)
-define(FDB_NET_OPTION_TRACE_ENABLE, 30).
...
-define(FDB_NET_OPTION_TRACE_ROLL_SIZE, 31).
...
-define(FDB_NET_OPTION_TRACE_MAX_LOGS_SIZE, 32).
...
-define(FDB_NET_OPTION_TRACE_FILE_IDENTIFIER, 36).
...
-define(FDB_NET_OPTION_TRACE_PARTIAL_FILE_SUFFIX, 39).

%% Set internal tuning or debugging knobs
%% Parameter: (String) knob_name=knob_value
-define(FDB_NET_OPTION_KNOB, 40).

%% Deprecated
%% Parameter: (String) file path or linker-resolved name
-define(FDB_NET_OPTION_TLS_PLUGIN, 41).

%% Set the certificate chain
%% Parameter: (Bytes) certificates
-define(FDB_NET_OPTION_TLS_CERT_BYTES, 42).

%% Set the file from which to load the certificate chain
%% Parameter: (String) file path
-define(FDB_NET_OPTION_TLS_CERT_PATH, 43).

%% Set the private key corresponding to your own certificate
%% Parameter: (Bytes) key
-define(FDB_NET_OPTION_TLS_KEY_BYTES, 45).

%% Set the file from which to load the private key corresponding to your own certificate
%% Parameter: (String) file path
-define(FDB_NET_OPTION_TLS_KEY_PATH, 46).

%% Set the peer certificate field verification criteria
%% Parameter: (Bytes) verification pattern
-define(FDB_NET_OPTION_TLS_VERIFY_PEERS, 47).

%%
%% Parameter: Option takes no parameter
-define(FDB_NET_OPTION_BUGGIFY_ENABLE, 48).

%%
%% Parameter: Option takes no parameter
-define(FDB_NET_OPTION_BUGGIFY_DISABLE, 49).
...
-define(FDB_NET_OPTION_BUGGIFY_SECTION_ACTIVATED_PROBABILITY, 50).

%% Set the probability of an active BUGGIFY section being fired
%% Parameter: (Int) probability expressed as a percentage between 0 and 100
-define(FDB_NET_OPTION_BUGGIFY_SECTION_FIRED_PROBABILITY, 51).

%% Set the ca bundle
%% Parameter: (Bytes) ca bundle
-define(FDB_NET_OPTION_TLS_CA_BYTES, 52).

%% Set the file from which to load the certificate authority bundle
%% Parameter: (String) file path
-define(FDB_NET_OPTION_TLS_CA_PATH, 53).
...
-define(FDB_NET_OPTION_TLS_PASSWORD, 54).
...
%% Parameter: Option takes no parameter
-define(FDB_NET_OPTION_DISABLE_MULTI_VERSION_CLIENT_API, 60).
...
%% Parameter: Option takes no parameter
-define(FDB_NET_OPTION_CALLBACKS_ON_EXTERNAL_THREADS, 61).
...
-define(FDB_NET_OPTION_EXTERNAL_CLIENT_LIBRARY, 62).
...
-define(FDB_NET_OPTION_CLIENT_THREADS_PER_VERSION, 65).

%% Retain temporary external client library copies that are created for enabling multi-threading.
%% Parameter: Option takes no parameter
-define(FDB_NET_OPTION_RETAIN_CLIENT_LIBRARY_COPIES, 67).

%% Disables logging of client statistics, such as sampled transaction activity.
%% Parameter: Option takes no parameter
-define(FDB_NET_OPTION_DISABLE_CLIENT_STATISTICS_LOGGING, 70).

%% Deprecated
%% Parameter: Option takes no parameter
-define(FDB_NET_OPTION_ENABLE_SLOW_TASK_PROFILING, 71).
...
-define(FDB_NET_OPTION_DISTRIBUTED_CLIENT_TRACER, 90).
...
-define(FDB_NET_OPTION_SUPPORTED_CLIENT_VERSIONS, 1000).
...
-define(FDB_NET_OPTION_EXTERNAL_CLIENT, 1001).
...
%% Parameter: Option takes no parameter
-define(FDB_DB_OPTION_SNAPSHOT_RYW_DISABLE, 27).
...
-define(FDB_DB_OPTION_TRANSACTION_LOGGING_MAX_FIELD_LENGTH, 405).
...
-define(FDB_DB_OPTION_TRANSACTION_TIMEOUT, 500).
...
-define(FDB_DB_OPTION_TRANSACTION_RETRY_LIMIT, 501).
...
-define(FDB_DB_OPTION_TRANSACTION_MAX_RETRY_DELAY, 502).
...
-define(FDB_DB_OPTION_TRANSACTION_SIZE_LIMIT, 503).
...
%% Parameter: Option takes no parameter
-define(FDB_DB_OPTION_TRANSACTION_CAUSAL_READ_RISKY, 504).
...
%% Parameter: Option takes no parameter
-define(FDB_DB_OPTION_TRANSACTION_INCLUDE_PORT_IN_ADDRESS, 505).
...
%% Parameter: Option takes no parameter
-define(FDB_DB_OPTION_TRANSACTION_BYPASS_UNREADABLE, 700).

%% Use configuration database.
%% Parameter: Option takes no parameter
-define(FDB_DB_OPTION_USE_CONFIG_DATABASE, 800).
...
%% Parameter: Option takes no parameter
-define(FDB_DB_OPTION_TEST_CAUSAL_READ_RISKY, 900).

%% The transaction, if not self-conflicting, may be committed a second time after commit succeeds, in the event of a fault
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_CAUSAL_WRITE_RISKY, 10).

%% The read version will be committed, and usually will be the latest committed, but might not be the latest committed in the event of a simultaneous fault and misbehaving clock.
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_CAUSAL_READ_RISKY, 20).

%%
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_CAUSAL_READ_DISABLE, 21).
...
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_INCLUDE_PORT_IN_ADDRESS, 23).

%% The next write performed on this transaction will not generate a write conflict range. As a result, other transactions which read the key(s) being modified by the next write will not conflict with this transaction. Care needs to be taken when using this option on a transaction that is shared between multiple threads. When setting this option, write conflict ranges will be disabled on the next write operation, regardless of what thread it is on.
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_NEXT_WRITE_NO_WRITE_CONFLICT_RANGE, 30).
...
%% Parameter: Option takes no parameter This is a hidden parameter and should not be used directly by applications.
-define(FDB_TR_OPTION_COMMIT_ON_FIRST_PROXY, 40).

%%
%% Parameter: Option takes no parameter This is a hidden parameter and should not be used directly by applications.
-define(FDB_TR_OPTION_CHECK_WRITES_ENABLE, 50).
...
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_READ_YOUR_WRITES_DISABLE, 51).

%% Deprecated
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_READ_AHEAD_DISABLE, 52).

%%
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_DURABILITY_DATACENTER, 110).

%%
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_DURABILITY_RISKY, 120).

%% Deprecated
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_DURABILITY_DEV_NULL_IS_WEB_SCALE, 130).
...
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_PRIORITY_SYSTEM_IMMEDIATE, 200).
...
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_PRIORITY_BATCH, 201).
...
-define(FDB_TR_OPTION_TRANSACTION_LOGGING_ENABLE, 402).
...
-define(FDB_TR_OPTION_DEBUG_TRANSACTION_IDENTIFIER, 403).
...
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_LOG_TRANSACTION, 404).
...
%% Parameter: (Int) Maximum length of escaped key and value fields.
-define(FDB_TR_OPTION_TRANSACTION_LOGGING_MAX_FIELD_LENGTH, 405).
...
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_SERVER_REQUEST_TRACING, 406).
...
%% Parameter: (Int) value in milliseconds of timeout
-define(FDB_TR_OPTION_TIMEOUT, 500).
...
%% Parameter: (Int) number of times to retry
-define(FDB_TR_OPTION_RETRY_LIMIT, 501).
...
%% Parameter: (Int) value in milliseconds of maximum delay
-define(FDB_TR_OPTION_MAX_RETRY_DELAY, 502).
...
%% Parameter: (Int) value in bytes
-define(FDB_TR_OPTION_SIZE_LIMIT, 503).

%% Snapshot read operations will see the results of writes done in the same transaction. This is the default behavior.
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_SNAPSHOT_RYW_ENABLE, 600).

%% Snapshot read operations will not see the results of writes done in the same transaction. This was the default behavior prior to API version 300.
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_SNAPSHOT_RYW_DISABLE, 601).

%% The transaction can read and write to locked databases, and is responsible for checking that it took the lock.
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_LOCK_AWARE, 700).
...
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_SPECIAL_KEY_SPACE_RELAXED, 713).
...
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_SPECIAL_KEY_SPACE_ENABLE_WRITES, 714).
...
%% Parameter: (String) String identifier used to associated this transaction with a throttling group. Must not exceed 16 characters.
-define(FDB_TR_OPTION_AUTO_THROTTLE_TAG, 801).
...
-define(FDB_TR_OPTION_SPAN_PARENT, 900).
...
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_EXPENSIVE_CLEAR_COST_ESTIMATION_ENABLE, 1000).
...
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_BYPASS_UNREADABLE, 1100).
...
%% Parameter: Option takes no parameter
-define(FDB_TR_OPTION_USE_GRV_CACHE, 1101).
...
-define(FDB_STREAMING_MODE_ITERATOR, -1).
...
-define(FDB_STREAMING_MODE_EXACT, 0).
...
-define(FDB_STREAMING_MODE_LARGE, 3).
...
-define(FDB_STREAMING_MODE_SERIAL, 4).
...
-define(FDB_MUTATION_TYPE_ADD, 2).

%% Deprecated
-define(FDB_MUTATION_TYPE_AND, 6).
...
-define(FDB_MUTATION_TYPE_BIT_AND, 6).

%% Deprecated
-define(FDB_MUTATION_TYPE_OR, 7).
...
-define(FDB_MUTATION_TYPE_BIT_OR, 7).

%% Deprecated
-define(FDB_MUTATION_TYPE_XOR, 8).
...
-define(FDB_MUTATION_TYPE_BIT_XOR, 8).
...
-define(FDB_MUTATION_TYPE_APPEND_IF_FITS, 9).
...
-define(FDB_MUTATION_TYPE_SET_VERSIONSTAMPED_KEY, 14).
...
-define(FDB_MUTATION_TYPE_SET_VERSIONSTAMPED_VALUE, 15).
...
-define(FDB_MUTATION_TYPE_BYTE_MIN, 16).
...
-define(FDB_MUTATION_TYPE_BYTE_MAX, 17).
...
-define(FDB_MUTATION_TYPE_COMPARE_AND_CLEAR, 20).

%% Used to add a read conflict range
-define(FDB_CONFLICT_RANGE_TYPE_READ, 0).

%% Used to add a write conflict range
-define(FDB_CONFLICT_RANGE_TYPE_WRITE, 1).
